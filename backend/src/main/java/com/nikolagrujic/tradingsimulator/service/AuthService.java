...
public class AuthService {
    ...
    private void handleUserNotVerified(User user) {
        LOGGER.warn("Email verification skipped for user: {}", user.getEmail());

        // Old tokens cleanup (optional, can be skipped as well)
        // emailVerificationService.deleteByUserId(user.getId());

        // Skipping sending verification email
